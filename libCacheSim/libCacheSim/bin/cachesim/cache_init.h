...
static inline cache_t *create_cache(const char *trace_path,
  ...
  } else if (strcasecmp(eviction_algo, "3l") == 0) {
    cache = create_3l_cache(cc_params);
...
#endif
  } else if (strcasecmp(eviction_algo, "AdaptiveClimbII") == 0) {
    cache = AdaptiveClimbII_init(cc_params, eviction_params);
  } else if (strcasecmp(eviction_algo, "AdaptiveClimb") == 0) {
    cache = AdaptiveClimb_init(cc_params, eviction_params);
  } else if (strcasecmp(eviction_algo, "DynamicAdaptiveClimb") == 0) {
    cache = DynamicAdaptiveClimb_init(cc_params, eviction_params);
  } else if (strcasecmp(eviction_algo, "ilru") == 0) {
    cache = iLRU_init(cc_params, eviction_params);
  } else {
